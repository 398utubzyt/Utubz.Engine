...
#region Alteration Notice
// Hey, 398 here, this is a modified version of Flibitijibibo's SDL2-CS,
// which can be found here: https://github.com/flibitijibibo/SDL2-CS

// This is going to be eventually replaced with my own bindings, but the
// generator I'm using (CppSharp) doesn't really like SDL for some reason.
#endregion
...
namespace Utubz.Internal.Native.Sdl2
{
